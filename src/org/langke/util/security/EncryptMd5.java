...
　　　　　   			字节拷贝到output的outpos位置开始   
				...
				*/   
                ...
                public   static   void   main(String   args[])   {   
                                EncryptMd5   m   =   new   EncryptMd5();   
                                if   (Array.getLength(args)   ==   0)   {       //如果没有参数，执行标准的Test   Suite   
	                                System.out.println("MD5   Test   suite:");    
	                                System.out.println("MD5(\"hzhost\"):"+m.encrypt("hzhost"));   
	                                if("c9184c8d6d06dd3184d34d2f4fe94a2a".equals(m.encrypt("hzhost").toLowerCase())){
	                                	System.out.println("ddddddddd");
	                                }
	                                System.out.println("MD5(\"abc\"):"+m.encrypt("abc"));   
	                                System.out.println("MD5(\"message   digest\"):"+m.encrypt("message   digest"));   
	                                System.out.println("MD5(\"abcdefghijklmnopqrstuvwxyz\"):"+   
	                                                m.encrypt("abcdefghijklmnopqrstuvwxyz"));   
	                                System.out.println("MD5(\"ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789\"):"+   
	                                          m.encrypt("ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789"));   
                                }else   
                                    System.out.println("MD5("   +   args[0]   +   ")="   +   m.encrypt(args[0]));
                                System.out.println("MD5(\"123456\"):"+m.encrypt("123456"));   
